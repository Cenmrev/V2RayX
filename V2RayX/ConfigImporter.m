...
+ (NSString* _Nonnull)decodeBase64String:(NSString*)encoded {
    ...
    @try {
        ...
        // M1 12.6 (21G115) 版本转码结果nil 增加过滤
        NSData* resultDate = [[[ConfigImporter alloc]init] replaceNoUtf8:decodedData];
        NSString* decodedString = [[NSString alloc] initWithData:resultDate encoding:NSUTF8StringEncoding];
